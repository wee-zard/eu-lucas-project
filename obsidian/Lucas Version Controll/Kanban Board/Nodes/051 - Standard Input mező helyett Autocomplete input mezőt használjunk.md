...
- MÓDOSÍTÁS
	- Amennyiben lehet, akkor minden select input mező kerüljön lecserélésre AutoComplete input mezőre.
	- Miért használjuk ezt inkább? Mivel a Select input mező esetén a felhasználó CSAK kiválaszthatja az adott opciót, de nem szűrhet rájuk. Egy AutoComplete input mező esetén lehetőség van arra, hogy kiválasszuk a legördülő opciók közül, illetve beképeljük az adott opció értékét. Tehát, egyszerűbb tehetjük az egyes opciók kiválasztását.