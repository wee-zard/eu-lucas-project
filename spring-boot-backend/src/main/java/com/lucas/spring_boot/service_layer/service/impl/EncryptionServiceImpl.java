...
public class EncryptionServiceImpl implements EncryptionService {
    ...
    private String getPreSaltedInput(String input) {
    ...
    public String encrypt(String strToEncrypt) {
        try {
            ...
            KeySpec spec = new PBEKeySpec(secretEncryptionKey.toCharArray(), secretEncryptionSalt.getBytes(), ITERATION_COUNT, KEY_LENGTH);
            ...
            byte[] cipherText = cipher.doFinal(getPreSaltedInput(strToEncrypt).getBytes(StandardCharsets.UTF_8));
