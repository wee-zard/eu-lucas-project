...
import com.lucas.spring.database.repositories.CoordinateYRepository;
...
public class CoordinateYServiceImpl implements CoordinateYService {
     ...
     */
    @Override
    public CoordinateYEntity getCoordinateY(Integer coordinateY) {
        Optional<CoordinateYEntity> selectedCoordinateY = getCoordinateYs()
                .stream()
                .filter(coordinateYEntity -> Objects.equals(coordinateYEntity.getCoordinateY(), coordinateY))
                .findFirst();
    ...
    public void addCoordinateY(Integer coordinateY) {
        CoordinateYEntity coordinateYEntity = CoordinateYEntity
                .builder()
                .coordinateY(coordinateY)
                .build();
        coordinateYRepository.save(coordinateYEntity);
    }
     ...
     */
    @Override
    public void isCoordinateYIncludedInTheDb(Integer coordinateY) {
        ArrayList<CoordinateYEntity> coordinateYEntities = getCoordinateYs();

        Optional<CoordinateYEntity> selectedCoordinateY = coordinateYEntities
                .stream()
                .filter(coordinateYEntity -> Objects.equals(coordinateYEntity.getCoordinateY(), coordinateY))
                .findAny();
